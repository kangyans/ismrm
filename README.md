...
<div style="border: 1px solid #f5c2c7; background-color: #f8d7da; padding: 10px; border-radius: 5px;">
  <strong>Notice: </strong> The fast abstract search tools doesn't support case-insensitive queries or searching by abstract number. The link to the 2025 ISMRM abstracts is currently unavailable. I'm waiting for the abstracts to be archived and accessible
</div>
